...
class MySpacer extends StatelessWidget {
  // by default height factor is 0.05
  const MySpacer({Key? key, required this.size, double heightFactor = 0.05})
      : heightFactorr = heightFactor,
        super(key: key);
  final Size size;
  final double heightFactorr;
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: size.height * heightFactorr,
    );
  }
}
